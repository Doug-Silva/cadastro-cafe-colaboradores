...
<div align="center">  
  ...
  <p>Foi desenvolvido uma aplicação java Web, com o framework Spring Boot, para cadastrar os colaboradores de uma empresa pelo setor e adicionar suas opções de café da manhã</p>
  ...
  <div style="width:30%">
    <a href='#voltar-topo'><img src="./others/tela-inicio-projeto.gif" style="width:100%" alt="Imagem do projeto"></a>   
  </div><hr>
  </div>
